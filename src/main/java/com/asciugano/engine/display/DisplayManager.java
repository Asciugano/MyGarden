      ...
      switch (key) {
        case GLFW_KEY_SPACE -> {
          if (action == GLFW_RELEASE)
            KeyHandler.SPACE_PRESSED = false;
          else if (action == GLFW_PRESS)
            KeyHandler.SPACE_PRESSED = true;
        }
        case GLFW_KEY_A -> {
          if (action == GLFW_RELEASE)
            KeyHandler.A_PRESSED = false;
          else if (action == GLFW_PRESS)
            KeyHandler.A_PRESSED = true;
        }
        case GLFW_KEY_D -> {
          if (action == GLFW_RELEASE)
            KeyHandler.D_PRESSED = false;
          else if (action == GLFW_PRESS)
            KeyHandler.D_PRESSED = true;
        }
        case GLFW_KEY_W -> {
          if (action == GLFW_RELEASE)
            KeyHandler.W_PRESSED = false;
          else if (action == GLFW_PRESS)
            KeyHandler.W_PRESSED = true;
        }
        case GLFW_KEY_S -> {
          if (action == GLFW_RELEASE)
            KeyHandler.S_PRESSED = false;
          else if (action == GLFW_PRESS)
            KeyHandler.S_PRESSED = true;
        }
      }
    });
